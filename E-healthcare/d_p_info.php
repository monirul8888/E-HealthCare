...
// Fetch doctor name from doctor ID
$stmt = $connection->prepare("SELECT dName FROM doctors WHERE dID = ?");
...
$appointments = [];
$sql = "SELECT * FROM appointment WHERE d_name = ?";
    ...
    <div class="content">
        ...
        <table>
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="6">No appointment records found for you.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
